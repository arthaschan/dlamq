...
public class Fbdcjinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar firstShuttlebusTime;
    ...
    public Calendar getFirstShuttlebusTime() {
        return firstShuttlebusTime;
    }

    public void setFirstShuttlebusTime(Calendar firstShuttlebusTime) {
        this.firstShuttlebusTime = firstShuttlebusTime;
    }
}
