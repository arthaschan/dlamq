...
public class Xlxjinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar baggageDownStartTime;
    ...
    public Calendar getBaggageDownStartTime() {
        return baggageDownStartTime;
    }

    public void setBaggageDownStartTime(Calendar baggageDownStartTime) {
        this.baggageDownStartTime = baggageDownStartTime;
    }
}
