...
public class Xlcseinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar baggageOverTime;
    ...
    public Calendar getBaggageOverTime() {
        return baggageOverTime;
    }

    public void setBaggageOverTime(Calendar baggageOverTime) {
        this.baggageOverTime = baggageOverTime;
    }
}
