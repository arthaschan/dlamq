...
public class Fjrwinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar planePlaceTime;
    ...
    public Calendar getPlanePlaceTime() {
        return planePlaceTime;
    }

    public void setPlanePlaceTime(Calendar planePlaceTime) {
        this.planePlaceTime = planePlaceTime;
    }
}
