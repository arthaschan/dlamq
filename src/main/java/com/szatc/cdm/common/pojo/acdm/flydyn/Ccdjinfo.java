...
public class Ccdjinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar urgingBoardingTime;
    ...
    public Calendar getUrgingBoardingTime() {
        return urgingBoardingTime;
    }

    public void setUrgingBoardingTime(Calendar urgingBoardingTime) {
        this.urgingBoardingTime = urgingBoardingTime;
    }
}
