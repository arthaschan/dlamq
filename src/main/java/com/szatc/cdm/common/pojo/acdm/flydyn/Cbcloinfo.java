...
public class Cbcloinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar cCabinintTime;
    ...
    public void setcCabinintTime(Calendar cCabinintTime) {
        this.cCabinintTime = cCabinintTime;
    }

    public Calendar getcCabinintTime() {
        return cCabinintTime;
    }
}
