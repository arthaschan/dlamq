...
public class Pweinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar sewageOverTime;
    ...
    public Calendar getSewageOverTime() {
        return sewageOverTime;
    }

    public void setSewageOverTime(Calendar sewageOverTime) {
        this.sewageOverTime = sewageOverTime;
    }
}
