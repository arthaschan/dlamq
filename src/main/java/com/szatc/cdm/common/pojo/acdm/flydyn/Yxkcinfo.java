...
public class Yxkcinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar allowDriveTime;
    ...
    public Calendar getAllowDriveTime() {
        return allowDriveTime;
    }

    public void setAllowDriveTime(Calendar allowDriveTime) {
        this.allowDriveTime = allowDriveTime;
    }
}
