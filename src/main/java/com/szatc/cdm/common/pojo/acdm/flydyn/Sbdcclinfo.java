...
public class Sbdcclinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar secondShuttlebusLeaveTime;
    ...
    public Calendar getSecondShuttlebusLeaveTime() {
        return secondShuttlebusLeaveTime;
    }

    public void setSecondShuttlebusLeaveTime(Calendar secondShuttlebusLeaveTime) {
        this.secondShuttlebusLeaveTime = secondShuttlebusLeaveTime;
    }
}
