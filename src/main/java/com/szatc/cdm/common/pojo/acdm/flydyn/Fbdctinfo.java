...
public class Fbdctinfo {
    @NotNest
    @Valid
    @NotNull(message = "必须有值")
    private FlightKeyType flightKey;
    private Calendar firstShuttlebusHallTime;
    ...
    public Calendar getFirstShuttlebusHallTime() {
        return firstShuttlebusHallTime;
    }

    public void setFirstShuttlebusHallTime(Calendar firstShuttlebusHallTime) {
        this.firstShuttlebusHallTime = firstShuttlebusHallTime;
    }
}
